...
`@script`
Welcome. In this lesson, we are going to learn how financial professionals use Python packages (i.e. Matplotlib and Seaborne) to visualize financial data in order to conduct Economic and Technical Analysis.
...
`@script`
Before we start, there're 6 steps in financial analysis:
...
This Chapter mainly focus on Step 3.
...
`@script`
In the finance world, analysis can mainly divided into 3 disciplines: fundamental, technical, quant, etc..

Regardless of which discipline, modern practitioners use various python libraries to quantify and visualize financial data. Common financial python library includes Matplotlib, seaborn, bone, pygal, geoplotlib. In the coming chapter, we will focus on the first two.
...
The ratio copper-gold ratio acts as an accurate barometer of global growth...In coming exercises, you will learn how to visualize this ratio relationship with the use of Matplotlib & Seaborn.
